...
def fix(filepath):
    ...
    start_str = "val matchChapter = if (currentSelectedChapters.isEmpty()) {"
    ...
    if start_idx != -1 and end_idx != -1:
        new_block = """val matchChapter = if (currentSelectedChapters.isEmpty()) {
                                true
                            } else {
