...
print(normalizeChapterName("Tense", "General English"))
print(normalizeChapterName("Tenses", "General English"))
print(normalizeChapterName("Present Tense", "General English"))
