...
val BrandSecondary = Color(0xFF1D4ED8)       // Blue 700 (One accent color)
val BrandSecondaryContainerLight = Color(0xFFEFF6FF) // Blue 50
val BrandOnSecondaryContainerLight = Color(0xFF1E3A8A) // Blue 900
val BrandSecondaryContainerDark = Color(0xFF1E3A8A)  // Blue 900
val BrandOnSecondaryContainerDark = Color(0xFFDBEAFE) // Blue 100

val BrandAccent = Color(0xFF2563EB)          // Blue (Primary)
val BrandAccentContainerLight = Color(0xFFDBEAFE)   // Blue 100
val BrandOnAccentContainerLight = Color(0xFF1E3A8A)  // Blue 900
val BrandAccentContainerDark = Color(0xFF1E3A8A)     // Blue 900
val BrandOnAccentContainerDark = Color(0xFFDBEAFE)   // Blue 100
...
val BrandError = Color(0xFFEF4444)           // Error Red (Only for warnings)
...
val LightSurface = Color(0xFFF1F5F9) // Slightly darker (light gray instead of pure white)
val LightSurfaceVariant = Color(0xFFE2E8F0)
val LightOnSurface = Color(0xFF0F172A)
val LightOnSurfaceVariant = Color(0xFF334155) // Increased contrast for secondary text (Slate 700)
